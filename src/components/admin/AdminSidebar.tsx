...
export function AdminSidebar({
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col overflow-hidden">
      <div
        className={cn(
          'flex h-16 shrink-0 items-center justify-between border-b border-border px-4 transition-all',
      ...
      <div className="flex-1 space-y-6 px-3 py-4 overflow-y-auto">
        {navGroups.map((group) => (
  ...
  return (
    <>
      <aside
        className={cn(
          'hidden md:flex flex-col sticky top-0 h-screen z-30 border-r border-border bg-card transition-all duration-300 ease-in-out shrink-0',
